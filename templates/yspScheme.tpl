      ...
      function validate(){
           ...
           hasError=false
            ...
            if(document.getElementById("departments").value.trim() ===""){
                errorMessage="Please select the right Department/Corporation/Board\n"
                hasError=true
                
            }
          
            if(document.getElementById("schemeNum").value.trim() ===""){
                errorMessage=errorMessage+" Please enter the right Scheme Number\n"
                hasError=true
            ...
            if(document.getElementById("shortname_eng").value.trim() ===""){
                errorMessage=errorMessage+" Please enter a meaningful Short Name for the scheme in English\n"
            ...
            if(document.getElementById("shortname_kan").value.trim()===""){
                errorMessage=errorMessage+" Please enter a meaningful Short Name for the scheme in Kannada\n"
            ...
            if(document.getElementById("name_eng").value.trim() === ""){
                errorMessage=errorMessage+" Please enter the right Scheme name in English\n"
            ...
            if(document.getElementById("name_kan").value.trim() === ""){
                errorMessage=errorMessage+" Please enter the right Scheme name in Kannada\n"
          ...
          //schemeData = {"scheme":{"department":"KSTDC","schemeNumber":"1","schemeID":"KSTDC-scheme-1","schemeName":{"label":{"kan":"ಯೋಜನೆ","eng":"Scheme"},"details":{"kan":"ಯೋಜನೆಯ ಪೂರ್ಣ ಹೆಸರು","eng":"Descriptive Name of the Scheme"}},"schemeShortName":{"label":{"kan":"ಯೋಜನೆಯ ಕಿರು-ಸಂಕ್ಷಿಪ್ತ ಹೆಸರ","eng":"Display or Short Name"},"details":{"kan":"ಕಿರು-ಸಂಕ್ಷಿಪ್ತ ಹೆಸರು","eng":"test"}},"detailedschemeName":{"label":{"kan":"ಯೋಜನೆಯ ವಿವರ","eng":"Scheme Details"},"details":{"kan":" ಯೋಜನೆಯ ವಿವರ","eng":" Scheme Description"}},"purpose":{"label":{"kan":"ಯೋಜನೆಯ ಉದ್ದೇಶ","eng":"Purpose of the scheme"},"details":"","additionalDetails":{"label":{"kan":"ಹೆಚ್ಚಿನ ವಿವರಗಳು","eng":"For Additional Details"},"fileName":""}},"facilities":{"label":{"kan":"ಯೋಜನೆಯಿಂದ ದೊರೆಯುವ ಸೌಲಭ್ಯಯಗಳು","eng":"Facilities available/ Details of the scheme"},"details":"","additionalDetails":{"label":{"kan":"ಹೆಚ್ಚಿನ ವಿವರಗಳು","eng":"For Additional Details"},"fileName":""}},"eligibility":{"label":{"kan":"ಯೋಜನೆಯ ಲಾಭ ಪಡೆಯಲು ಇರಬೇಕಾದ ಅರ್ಹತೆಗಳು/ಮಾನದಂಡಗಳು","eng":"Eligibility to reap the benefits of the scheme"},"details":"","additionalDetails":{"label":{"kan":"ಹೆಚ್ಚಿನ ವಿವರಗಳು","eng":"For Additional Details"},"fileName":""}},"qualifications":{"label":{"kan":"ಯಾರಿಗೆ ಈ ಯೋಜನೆ","eng":"Qualification to reap the benefits of the scheme"},"details":"","additionalDetails":{"label":{"kan":"ಹೆಚ್ಚಿನ ವಿವರಗಳು","eng":"For Additional Details"},"fileName":""}},"sakala":{"label":{"kan":"ಸಕಾಲ ವ್ಯಾಪ್ತಿಗೆ ಬರುತ್ತದೆಯೇ?","eng":"Does it come under Sakala?"},"details":"false"},"process":{"label":{"kan":"ಯೋಜನೆಯ ಪ್ರಕ್ರಿಯೆ","eng":"Process for applying"},"details":"","additionalDetails":{"label":{"kan":"ಹೆಚ್ಚಿನ ವಿವರಗಳು","eng":"For Additional Details"},"fileName":""}},"documents":{"label":{"kan":"ಅರ್ಜಿಯೊಂದಿಗೆ ಸಲ್ಲಿಸಬೇಕಾದ ದಾಖಲೆಗಳು","eng":"Documents to be submitted"},"details":"","additionalDetails":{"label":{"kan":"ಹೆಚ್ಚಿನ ವಿವರಗಳು","eng":"For Additional Details"},"fileName":""}},"contactOffice":{"label":{"kan":"ಹೆಚ್ಚಿನ ಮಾಹಿತಿಗಾಗೆ ಸಂಪರ್ಕಿಸಬೇಕಾದ ಕಛೇರಿ","eng":"Contact Office"},"details":"","website":"","email":"","contactNumbers":[{"type":"contact","type_eng":"Contact","type_kan":"ದೂರವಾಣಿ/ಮೊಬೈಲ್ ಸಂಖ್ಯೆ","num":"","numbersfileLink":null},{"type":"helpline","eng":"Helpline","kan":"ಸಹಾಯವಾಣಿ","num":"","numbersfileLink":"link 2 District Offices Contact details"}],"contactsURL":""},"additionalContactInformation":{"labels":[{"kan":"ಹೆಸರು","eng":"Name"},{"kan":"ಪದನಾಮ","eng":"Designation"},{"kan":"ಇ-ಮೇಲ್ ","eng":"EmailId "},{"kan":"ಕಛೇರಿ ವಿಳಾಸ","eng":"Office Address"},{"kan":"ದೂರವಾಣಿ/ಮೊಬೈಲ್ ಸಂಖ್ಯೆ","eng":"Contact Number"}],"details":"","contactsURL":""},"applicationMode":"","applicationFormLocation":null,"applicationURL":null,"subsidies":{"label":{"kan":"ಯೋಜನೆಯಿಂದ ದೊರೆಯುವ ರಿಯಾಯತಿಗಳು","eng":"Subsidies available under the scheme"},"details":"","subsidiesDistributionExample":{"label":{"kan":"ರಿಯಾಯತಿ - ಉದಾಹರಣೆ","eng":"An example of Subsidy Distribution "},"details":""},"additionalDetails":{"label":{"kan":"ಹೆಚ್ಚಿನ ವಿವರಗಳು","eng":"For Additional Details"},"fileName":""}}}}
        ...
        fr.onload = function(evt){
           document.body.innerHTML = "<br><a href="+URL.createObjectURL(file)+" download=" + file.name + ">Download " + file.name + "</a>"
        }
        ...
        fr.readAsText(file);
          ...
          document.getElementById("errorMessage").value="The data is saved"
  ...
  border-collapse: collapse;
    ...
    <body class="login-page sidebar-collapse">  
        <div class="container">
                        ...
                        <td>
                            <select name="departments" id="departments" class="form-control input-lg" required>
                                 ...
                                 % for y in data['Departments']:
                                    <option value="{{!y['department']['Dep_ID']}}" >{{!y['department']['Dep_Short_Name_English']}}</option>
                                % end
            ...
            <div id="schemeHeading" style="display: block;">
             <table>
                 ...
                 <tr>
                        ...
                        <td>
                            <input name="name_eng" type="text" class="form-control-1 " id="name_eng" required maxlength = "300">
                        </td>
                        <td>
                            <input name="name_kan" type="text" class="form-contro1-1 " id="name_kan" required maxlength = "300">
                        </td>
            ...
            <center> <button class="btn btn-rose btn-raised validate" style="" id="validate" onclick="validate()">VALIDATE</button> <br>
            <textarea name="errorMessage" type="textarea" rows="4" cols="50"  id="errorMessage" maxlength="100000" > Error if any will be displayed here!! </textarea><br>
            <textarea name="jsontext" type="textarea" rows="4" cols="50"  id="jsontext" maxlength="100000"> </textarea></center>
