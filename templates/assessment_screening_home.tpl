  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      document.getElementById('q_5_ig').style.display = 'none'
         document.getElementById('q_5_q_summary').style.display = 'none'
        document.getElementById('q_5_msg').style.display = 'none'
        document.getElementById('q_5_brk').style.display = 'none'
